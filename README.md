...
- [TrustVC Decentralized Renderer](https://docs.TrustVC.io/docs/tutorial/decentralised-renderer)
...
- render a document:
  ...
  - payload: object with 2 properties
    - document: (mandatory) document data as returned by `getData` method from [@TrustVC-tt/TrustVC](https://github.com/TrustVC/TrustVC)
...
- request for the list of templates for a document. The action directly return the list of templates
  - type: `GET_TEMPLATES`
  - payload: (mandatory) document data as returned by `getData` method from [@TrustVC-tt/TrustVC](https://github.com/TrustVC/TrustVC)
...
We also provided a [github template](https://github.com/TrustVC/TrustVC-decentralized-renderer) to build your own decentralized-renderer based on this library
